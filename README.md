...
My name is **Raja**, passionate about IT. `JavaScript` ecosystem enthusiast, I also like things related to `computer security` and `open source`.
...
🌐 You can visit my <a href="https://portfolio-raja.netlify.app/">Portfolio</a> <br> 💻 I use **Arch linux** distro based as my operating system <br> 🔭 I’m currently working on **JavaScript/TypeScript** - **React.js** - **Pocketbase** - **Bun.js** <br> 🌱 I’m currently learning **Go lang**</td>
